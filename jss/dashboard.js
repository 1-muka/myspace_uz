document.addEventListener("DOMContentLoaded", () => {
    ...
    const accessCodes = {
        ...
        listening: { test1: "EMERALD1", test2: "EMERALD2", test3: "EMERALD3", test4: "EMERALD4", test5: "EMERALD5", test6: "EMERALD6", test7: "EMERALD7", test8: "EMERALD8" },
        reading: { test1: "READ1", test2: "READ2", test3: "READ3", test4: "READ4", test5: "READ5", test6: "READ6" }
    };
                ...
                : myResults.map(r => `
                    <div style="display:flex;justify-content:space-between;align-items:center;padding:10px 0;border-bottom:1px solid #eee">
                        <span style="font-weight:600;text-transform:capitalize">
                            ${r.section === "reading"
                                ? `<a href="${({ test2: "reading-test2.html", test3: "reading-test3.html", test4: "reading-test4.html", test5: "reading-test5.html", test6: "reading-test6.html" }[r.testId] || "reading-test1.html")}?review=${encodeURIComponent(r.id || "")}" style="color:#0d8a5e;text-decoration:none;">${r.section} — ${r.testId || ""} (review)</a>`
                                : r.section === "listening"
                                    ? `<a href="${({ test2: "listening-test2.html", test3: "listening-test3.html", test4: "listening-test4.html", test5: "listening-test5.html", test6: "listening-test6.html", test7: "listening-test7.html", test8: "listening-test8.html", "full-mock-test2": "full-mock-test2.html", "full-mock-test3": "full-mock-test3.html", "full-mock-test4": "full-mock-test4.html" }[r.testId] || "listening-test1.html")}?review=${encodeURIComponent(r.id || "")}" style="color:#0d8a5e;text-decoration:none;">${r.section} — ${r.testId || ""} (review)</a>`
                                    : r.section === "writing"
